...
import {MODERATION_MESSAGES, MODERATION_STATUS} from "@/constants/response-messages.constant";
...
export class ModerationController {
    ...
    updateModeration: RouteHandler = async (req, reply) => {
        ...
        if (![MODERATION_STATUS.APPROVED, MODERATION_STATUS.REJECTED].includes(status)) {
