            ...
            <div className="grid grid-cols-3 gap-2">
              {user.photos &&
                user.photos.map((photo, index) => (
                  <div key={index} className="aspect-square relative rounded-md overflow-hidden bg-slate-100 group">
                    <img
              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-3 gap-4">
                  <div className="flex flex-col items-center">
                    <div className="bg-gradient-to-br from-pink-100 to-pink-200 rounded-full p-3 mb-2">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-full p-3 mb-2">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-full p-3 mb-2">
        ...
        <Card className="mb-6 bg-gradient-to-r from-purple-500 to-pink-500 text-white">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="font-bold text-lg">Free Member</h3>
                <p className="text-sm text-white/80">Basic features</p>
              </div>
