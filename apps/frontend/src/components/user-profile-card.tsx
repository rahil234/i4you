...
export const UserProfileCard = forwardRef(({ user, onMatch }: UserProfileProps, ref) => {
  const { likeUser, superLikeUser, dislikeUser } = useMatchesStore();
