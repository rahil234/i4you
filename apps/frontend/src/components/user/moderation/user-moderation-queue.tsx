...
interface ProfilePhotoItem extends CommonFields {
  type: 'profile_photo';
  images: string[];
}

interface BioTextItem extends CommonFields {
  type: 'bio_text';
  text: string;
}

type Item = ProfilePhotoItem | BioTextItem;
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start justify-between">
                ...
                <Badge variant="outline" className="flex items-center gap-1">
                  ...
                  {item.type === 'profile_photo' ? 'Avatar' : 'Bio Text'}
                </Badge>
              </div>
