...
interface ChatStore {
    ...
    unreadMessageCount: { [chatId: string]: number };
    ...
    resetMessageUnreadCount: (chatId: string) => void;
    ...
    return {
        ...
        fetchMessages: async (chatId, page) => {
            ...
            set({
                ...
                unreadChatCount: Math.max(0, get().unreadChatCount - 1),
                unreadMessageCount: {
                    ...get().unreadMessageCount,
                    [chatId]: Math.max(0, (get().unreadMessageCount[chatId] || 1) - 1)
                },
                isMessagesLoading: false,
        ...
        newChat: (chat, message) => {
            set((state) => ({
                ...
                unreadMessageCount: {
                    ...
                    [chat.id]: (state.unreadMessageCount[chat.id] || 0) + 1
                },
            }), undefined, 'chatStore/newChat/updateState');
        ...
        newMessage: (message) => {
            ...
            set((state) => ({
                ...
                unreadMessageCount: {
                    ...state.unreadMessageCount,
                    [message.chatId]: (state.unreadMessageCount[message.chatId] || 0) + 1
                },
                unreadChatCount: state.unreadChatCount + 1
        ...
        resetChatUnreadCount: () => {
            set({unreadChatCount: 0}, undefined, 'chatStore/resetChatUnreadCount');
        },
