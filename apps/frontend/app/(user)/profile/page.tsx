              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {user.interests.map((interest, index) => (
                    <span key={index} className="text-xs bg-slate-100 text-slate-800 px-2 py-1 rounded-full">
                      {interest}
                    </span>
                  ))}
                </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-2">
              {user.photos.map((photo, index) => (
                <div key={index} className="aspect-square relative rounded-md overflow-hidden bg-slate-100">
                  <img
