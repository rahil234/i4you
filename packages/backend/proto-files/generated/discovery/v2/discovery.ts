...
export const GetPotentialMatchesRequest: MessageFns<GetPotentialMatchesRequest> = {
  ...
  fromJSON(object: any): GetPotentialMatchesRequest {
    return {
      showMe: isSet(object.showMe)
        ? globalThis.String(object.showMe)
        : isSet(object.show_me)
        ? globalThis.String(object.show_me)
        : "",
      minAge: isSet(object.minAge)
        ? globalThis.Number(object.minAge)
        : isSet(object.min_age)
        ? globalThis.Number(object.min_age)
        : 0,
      ...
      maxDistance: isSet(object.maxDistance)
        ? globalThis.Number(object.maxDistance)
        : isSet(object.max_distance)
        ? globalThis.Number(object.max_distance)
        : 0,
      locationLat: isSet(object.locationLat)
        ? globalThis.Number(object.locationLat)
        : isSet(object.location_lat)
        ? globalThis.Number(object.location_lat)
        : 0,
      locationLng: isSet(object.locationLng)
        ? globalThis.Number(object.locationLng)
        : isSet(object.location_lng)
        ? globalThis.Number(object.location_lng)
        : 0,
      lookingFor: isSet(object.lookingFor)
        ? globalThis.String(object.lookingFor)
        : isSet(object.looking_for)
        ? globalThis.String(object.looking_for)
        : "",
      excludeUserIds: globalThis.Array.isArray(object?.excludeUserIds)
        ? object.excludeUserIds.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.exclude_user_ids)
        ? object.exclude_user_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
